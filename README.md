...
<div align="left"> 类似Windows原版charmap.exe，选择字符可查看该字体在映射表的分布，支持分组查看，能选择多个字符并复制，还能通过搜索查找文字和Unicode <div>
...
`sudo apt update && sudo apt install patchelf -y`

pip安装下列模块：

`pip3 install pyqt6 nuitka==4.0.8 zstandard`
