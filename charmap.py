...
class CharMapApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        import_btn.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        import_btn.setStyleSheet("padding-right: 10px;")
        
        self.import_button = QLabel("[点击选择字体文件]")
        self.import_button.setStyleSheet(
            "color: blue; text-decoration: underline; padding-left: 5px;"
        )
        ...
        toolbar_layout.addWidget(QLabel("选择字体:"))
        ...
        # 添加状态栏标签
        self.char_info_label = QLabel("未选择字体")
        self.status_bar.addWidget(self.char_info_label)
    ...
    def refresh_font_list(self):
        ...
        for font_file in self.font_files:
            self.font_combo.addItem(os.path.basename(font_file), font_file)
